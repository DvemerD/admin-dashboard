...
from .views import ProcessedTransaction, ProcessedTransactionRequestView, TransactionRequestDownloadView


urlpatterns = [
    path('new_transaction/', ProcessedTransaction.as_view()), #Link to get a list of transaction requests
